    ...
    <div className='pt-20 md:py-20 px-4 sm:px-10 md:px-32 bg-[#f7f7f7]'>
      ...
      <div className='flex flex-col lg:flex-row  gap-10 pt-20'>
        <div className='flex-1 bg-white shadow-lg rounded-lg p-5 text-center mt-10'>
          <div className='flex items-center justify-center -mt-20 mb-10'>
            <div className='p-5 bg-white rounded-full'>
              <AiOutlineSafetyCertificate color='#0080FE' size='40' />
            </div>
          </div>
          <h1 className='text-[#0080FE] font-bold text-1xl'> Demenagment formule camion avec chauffeur </h1>
        ...
        <div className='flex-1 bg-white shadow-lg rounded-lg p-5 text-center mt-10'>
          <div className='flex items-center justify-center -mt-20 mb-10'>
            <div className='p-5 bg-white rounded-full'>
              <AiOutlineEuroCircle color='#0080FE' size='40' />
            </div>
          </div>
          <h1 className='text-[#0080FE] font-bold text-1xl'> Demenagment formule économique </h1>
          <p className='text-xs md:text-base my-3 text-gray-500'>
        ...
        <div className='flex-1 bg-white shadow-lg rounded-lg p-5 text-center mt-10'>
          <div className='flex items-center justify-center -mt-20 mb-10'>
            <div className='p-5 bg-white rounded-full'>
              <GiFlexibleStar color='#0080FE' size='40' />
            </div>
          </div>
          <h1 className='text-[#0080FE] font-bold text-1xl'> Demenagment formule standard </h1>
          <p className='text-xs md:text-base my-3 text-gray-500'>
        ...
        <div className='flex-1 bg-white shadow-lg rounded-lg p-5 text-center mt-10'>
          ...
          <h1 className='text-[#0080FE] font-bold text-1xl'> Demenagment formule lux clé en main </h1>
          <p className='text-xs md:text-base my-3 text-gray-500'>
